 	...
 	alert('Selected ' + dates);
		...
		regionalOptions: { // Available regional settings, indexed by language/country code
			'': { // Default regional settings - English/US
				...
				monthNamesShort: ['Ene', 'Feb', 'Mar', 'Abr', 'May', 'Jun', 'Jul', 'Aug', 'Set', 'Oct', 'Nov', 'Dic'],
				...
				prevJumpText: '&lt;&lt;',
				prevJumpStatus: 'Mostrar año anterior',
				nextText: 'Sig&gt;',
				nextStatus: 'Mostrar mes siguiente',
				nextJumpText: '&gt;&gt;',
				nextJumpStatus: 'Mostrar año siguiente',
				currentText: 'Actual',
				currentStatus: 'Mostrar mes actual',
				todayText: 'Hoy',
				todayStatus: 'Mostrar el mes de la fecha actual',
				clearText: 'Limpiar',
				clearStatus: 'Limpiar todas las fechas',
				closeText: 'Cerrar',
				closeStatus: 'Cerrar el calendario',
				yearStatus: 'Cambiar el año',
				earlierText: '&#160;&#160;▲',
				laterText: '&#160;&#160;▼',
				monthStatus: 'Cambiar el mes',
				weekText: 'Se',
				weekStatus: 'Semana del año',
				dayStatus: 'Seleccionar DD, M d, yyyy',
				defaultStatus: 'Seleccionar una fecha',
				isRTL: false
			}
		},
