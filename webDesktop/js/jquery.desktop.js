...
function webdesktop(left, top, width, height) {
    this.Left = left;
    this.Top = top;
    this.Width = width;
    this.Height = height;
        ...
        init: {
            ...
            desktop: function () {
                ...
                d.on('dblclick', 'a.icon', function () {
                    ...
                    //if(y=="#window_computer"){
                    //    $(y).load("computer.aspx");
                    //};
                    //if (y == "#window_drive") {
                    //    $(y).load("drive.aspx");
                    //};
            ...
            wallpaper: function () {
                ...
                if ($('#desktop').length) {
                    $('body').prepend('<img id="wallpaper" class="abs" src="images/misc/wallpaper3.jpg" />');
                }
            }
        },
        util: {
